...
def default_settings() -> SettingsIn:
    return SettingsIn(
        ...
        update_check_enabled=os.getenv("BBM_UPDATE_CHECK_ENABLED", "1").lower() not in {"0", "false", "no"},
        update_check_interval_hours=_environment_limit("BBM_UPDATE_CHECK_INTERVAL_HOURS", 24, 1, 720),
