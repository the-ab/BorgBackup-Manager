...
BACKUP_CACHE_MAX_FILE_BYTES = int(os.getenv("BBM_BACKUP_CACHE_MAX_FILE_BYTES", str(32 * 1024 * 1024 * 1024)))
BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES = int(os.getenv("BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES", str(128 * 1024 * 1024 * 1024)))
BACKUP_CACHE_MAX_ENTRIES = int(os.getenv("BBM_BACKUP_CACHE_MAX_ENTRIES", "250000"))
BACKUP_CACHE_MAX_COMPRESSION_RATIO = int(os.getenv("BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO", "5000"))
for _name, _value in {
    ...
    "BBM_BACKUP_CACHE_MAX_FILE_BYTES": BACKUP_CACHE_MAX_FILE_BYTES,
