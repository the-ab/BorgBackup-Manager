(() => {
  ...
  const exact = {
    ...
    'Eine Ebene höher': 'Up one level', 'Browser schließen': 'Close browser',
    'Nur direkte Unterordner von': 'Only direct subdirectories of',
    'mit einer Borg-': 'with a Borg', 'können eingebunden werden. Symbolische Links werden nicht geöffnet.': 'can be imported. Symbolic links are not opened.',
