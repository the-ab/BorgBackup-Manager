(() => {
  ...
  const exact = {
    ...
    'Interface-Anzeige in der Kopfzeile': 'Interface display in header', 'Optional bis zu drei Interfaces mit IP-Adresse sowie aktueller Download- und Uploadrate dauerhaft anzeigen.': 'Optionally show up to three interfaces with IP address and current download/upload rate permanently in the header.',
    ...
    'Bei automatischer Auswahl werden aktive Interfaces mit IPv4-Adresse bevorzugt. Bei manueller Auswahl können höchstens drei Interfaces gewählt werden. Für entfernte Geräte erfolgt die Abfrage über den vorhandenen Controller-SSH-Zugang.': 'Automatic selection prefers active interfaces with an IPv4 address. Manual selection allows at most three interfaces. Remote devices are queried through the existing controller SSH access.',
