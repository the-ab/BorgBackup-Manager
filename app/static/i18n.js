(() => {
  ...
  const exact = {
    ...
    'Updateprüfung': 'Update check', 'Prüft GitHub Releases auf eine neuere BorgBackup-Manager-Version.': 'Checks GitHub Releases for a newer BorgBackup Manager version.', 'Jetzt prüfen': 'Check now', 'Automatisch nach neuen Releases suchen': 'Automatically check for new releases', 'Prüfintervall (Stunden)': 'Check interval (hours)', 'Standard: alle 24 Stunden. Bei deaktivierter Prüfung werden keine Verbindungen zu GitHub für die Versionsprüfung aufgebaut.': 'Default: every 24 hours. When disabled, no GitHub connection is made for version checks.',
    'Release Notes': 'Release notes', 'Dienst erreichbar': 'Service available', 'Systemstatus: Störung und Entwarnung': 'System status: outage and recovery', 'Systemstatus-Meldungen werden nur bei bestätigten Zustandswechseln versendet: einmal bei einer Störung und einmal nach der Wiederherstellung.': 'System status notifications are sent only for confirmed state changes: once for an outage and once after recovery.', 'Updateprüfung …': 'Checking for updates …', 'Update verfügbar': 'Update available', 'Version aktuell': 'Version current', 'Updateprüfung fehlgeschlagen': 'Update check failed', 'Updateprüfung deaktiviert': 'Update check disabled', 'Darstellung & Sprache': 'Appearance & language',
    ...
    'Repository-Server:': 'Repository server:', 'Repository-Dateisysteme': 'Repository filesystems', 'Serverprüfungen': 'Server checks',
    'Repository R/W/X': 'Repository R/W/X', 'sshd lauscht': 'sshd listening', 'sshd-Konfiguration': 'sshd configuration',
    'authorized_keys lesbar': 'authorized_keys readable', 'Forced Command': 'Forced command', 'Log schreibbar': 'Log writable',
    'Wrapper ausführbar': 'Wrapper executable', 'Zugänge vollständig': 'Accesses complete',
    'Gemeinsam genutzte Repositories': 'Shared repositories',
    'Serverprotokolle': 'Server logs', 'sshd-Log': 'sshd log', 'borg-serve-Log': 'borg-serve log',
    ...
    'Gespeicherte SSH-Aktionen': 'Saved SSH actions', 'Wiederkehrende Wartungsbefehle auf verbundenen Geräten kontrolliert ausführen.': 'Run recurring maintenance commands on connected devices in a controlled way.',
    'Gerät': 'Device', 'Aktionsname': 'Action name', 'Zeitlimit (Sekunden)': 'Timeout (seconds)', 'Aktion aktivieren': 'Enable action',
    'SSH-Befehl': 'SSH command', 'SSH-Aktion speichern': 'Save SSH action', 'Noch keine SSH-Aktionen gespeichert.': 'No SSH actions saved yet.',
    'Ausführen': 'Run', 'Bearbeiten': 'Edit', 'Löschen': 'Delete', 'Zeitlimit': 'Timeout',
    ...
    'Speicherplatz-Sperre': 'Storage guard', 'Globale Einstellung übernehmen': 'Inherit global setting', 'Externer Standard: deaktiviert': 'External default: disabled',
    ...
    'Eigene Sperrgrenze in Prozent': 'Custom threshold in percent', 'Status / ID': 'Status / ID', 'Belegung': 'Filesystem usage',
    ...
    'gezielt durchsuchen.': 'directly.', 'Automatisch suchen': 'Search automatically', 'Ordner auswählen': 'Select folder',
    'Suche oder Dateibrowser bei Bedarf starten.': 'Start the search or folder browser when needed.',
    'Eine Ebene höher': 'Up one level', 'Browser schließen': 'Close browser', 'Dieses Repository auswählen': 'Select this repository',
    ...
    'Verzeichnisinhalt wird geladen …': 'Loading directory contents …', 'Dieses Verzeichnis ist leer.': 'This directory is empty.',
    'Repository auswählen': 'Select repository', 'Öffnen': 'Open', 'Borg-Repository': 'Borg repository', 'Ordner': 'Folder', 'Datei': 'File',
    'Symbolischer Link': 'Symbolic link', 'Es werden maximal 500 Einträge angezeigt.': 'A maximum of 500 entries is shown.',
    'Repository fehlt': 'Repository missing', 'nicht verfügbar': 'unavailable', 'Status aktualisieren': 'Refresh status', 'Zurücksetzen': 'Reset',
    ...
    'Dateisystem- und Konsistenzoptionen': 'Filesystem and consistency options', 'Nur jeweiliges Quelldateisystem': 'Stay on each source filesystem', '(eingehängte Unterverzeichnisse überspringen)': '(skip mounted subdirectories)',
    ...
    'Cache-Backup verschlüsseln': 'Encrypt cache backup', '(empfohlen)': '(recommended)',
    ...
    'Kompression': 'Compression', 'Schnell – Deflate 1': 'Fast – Deflate 1', 'Standard – Deflate 6': 'Standard – Deflate 6',
    'Maximum – Deflate 9': 'Maximum – Deflate 9', 'Keine Kompression': 'No compression',
    ...
    'Borg-Cache verwalten': 'Manage Borg cache', 'Cache prüfen': 'Check cache', 'Verwaiste Daten bereinigen': 'Clean orphaned data',
    ...
    'Client-Caches und Borg-Sicherheitsstatus': 'Client caches and Borg security state', 'Client-Zustand prüfen': 'Check client state', 'Verwaisten Borg-Sicherheitsstatus bereinigen': 'Clean orphaned Borg security state',
    'Manager-Cache': 'Manager cache', 'Manager-Cache prüfen': 'Check manager cache', 'Verwaiste Manager-Daten bereinigen': 'Clean orphaned manager data',
    'Manager-Cache und Borg-Sicherheitsstatus': 'Manager cache and Borg security state', 'Manager-Zustand prüfen': 'Check manager state', 'Ausgewählte Manager-Daten bereinigen': 'Clean selected manager data',
    'Prüfumfang': 'Scan scope', 'Alle Geräte': 'All devices', 'Ausgewählte Geräte': 'Selected devices', 'Geräte': 'Devices', 'Mehrfachauswahl mit Strg/⌘ oder Umschalt.': 'Use Ctrl/⌘ or Shift for multiple selection.',
    'Verwaiste BBM-Client-Caches bereinigen': 'Clean orphaned BBM client caches', 'BBM-Client-Cache zurücksetzen': 'Reset BBM client cache', 'Legacy-Borg-Cache bereinigen': 'Clean legacy Borg cache', 'Ausgewählten Borg-Sicherheitsstatus bereinigen': 'Clean selected Borg security state',
    ...
    'Client-Caches prüfen': 'Check client caches', 'Verwaiste Client-Caches bereinigen': 'Clean orphaned client caches', 'Rückfall-Sicherungen bereinigen': 'Clean restore safety copies',
    ...
    'Backup erstellen': 'Create backup', 'Backup hochladen': 'Upload manager backup', 'Backup hochladen': 'Upload backup',
    ...
    'Manager-Backups': 'Manager backups', 'Cache-Backups': 'Cache backups', 'Separat von den BBM-Daten gespeichert.': 'Stored separately from BBM data.',
    'Gesicherte Client-Caches anzeigen': 'Show saved client caches', 'Client-Caches': 'Client caches',
    ...
    'gesichert': 'saved', 'nicht vorhanden': 'missing', 'übersprungen': 'skipped',
    ...
    'Anzeige und Aktualisierung': 'Display and refresh', 'Darstellung, Listenlimits und Hintergrundaktualisierung der WebUI.': 'Appearance, list limits and background refresh of the web UI.',
    'Interface-Anzeige in der Kopfzeile': 'Interface display in header', 'Optional bis zu fünf Interfaces mit IP-Adresse sowie aktueller Download- und Uploadrate dauerhaft anzeigen.': 'Optionally show up to five interfaces with IP address and current download/upload rate permanently in the header.',
    'Interfaces neu laden': 'Reload interfaces', 'Interface-Anzeige aktivieren': 'Enable interface display', 'Datenquelle': 'Data source',
    'BBM-Hostsystem': 'BBM host system', 'Verwaltetes Gerät': 'Managed device', 'Gerät auswählen': 'Select device',
    'Maximal angezeigte Interfaces': 'Maximum displayed interfaces', 'Aktualisierungsintervall (Sekunden)': 'Refresh interval (seconds)',
    'Interfaces automatisch auswählen': 'Select interfaces automatically', 'Interfaces werden nach Auswahl der Datenquelle geladen.': 'Interfaces are loaded after selecting the data source.',
    ...
    'Repository-Nachbereitung': 'Repository post-processing', 'Automatische Aktualisierung und Compact-Verhalten nach schreibenden Vorgängen.': 'Automatic refresh and compact behavior after write operations.',
    'Systemeinstellungen': 'System settings', 'Änderungen aller Bereiche gemeinsam speichern.': 'Save changes from all sections together.',
    ...
    'Max. parallel': 'Max. parallel', 'Job stoppen': 'Stop job',
    ...
    'Sitzung': 'Session', 'Session-Timeout bei Inaktivität (Minuten)': 'Idle session timeout (minutes)',
    ...
    'Abgelaufene jetzt bereinigen': 'Clean expired now', 'Alle abgeschlossenen löschen': 'Delete all completed', 'Alle Protokolle löschen': 'Delete all logs',
    ...
    'Vorlage zur Liste hinzufügen': 'Add template to list', 'Neue Vorlage': 'New template', 'Vorlage auswählen': 'Select template', 'Keine Vorlage vorhanden': 'No template available',
    'Vorlagenname': 'Template name', 'Ausschlussmuster': 'Exclusion patterns', 'Vorlage löschen': 'Delete template', 'Noch keine Ausschlussvorlage angelegt.': 'No exclusion template created yet.',
    ...
    'aktiv': 'active', 'inaktiv': 'inactive', 'blockiert': 'blocked', 'Blockiert': 'Blocked', 'teilweise blockiert': 'partially blocked',
