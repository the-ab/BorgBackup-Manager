...
existing_backup_cache_file_limit="$(read_existing BBM_BACKUP_CACHE_MAX_FILE_BYTES)"
existing_backup_cache_uncompressed_limit="$(read_existing BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES)"
existing_backup_cache_entries="$(read_existing BBM_BACKUP_CACHE_MAX_ENTRIES)"
existing_backup_cache_ratio="$(read_existing BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO)"
...
BBM_BACKUP_CACHE_MAX_FILE_BYTES="${BBM_BACKUP_CACHE_MAX_FILE_BYTES:-${existing_backup_cache_file_limit:-34359738368}}"
BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES="${BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES:-${existing_backup_cache_uncompressed_limit:-137438953472}}"
BBM_BACKUP_CACHE_MAX_ENTRIES="${BBM_BACKUP_CACHE_MAX_ENTRIES:-${existing_backup_cache_entries:-250000}}"
BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO="${BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO:-${existing_backup_cache_ratio:-5000}}"
...
BBM_BACKUP_CACHE_MAX_FILE_BYTES=$BBM_BACKUP_CACHE_MAX_FILE_BYTES
BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES=$BBM_BACKUP_CACHE_MAX_UNCOMPRESSED_BYTES
BBM_BACKUP_CACHE_MAX_ENTRIES=$BBM_BACKUP_CACHE_MAX_ENTRIES
BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO=$BBM_BACKUP_CACHE_MAX_COMPRESSION_RATIO
