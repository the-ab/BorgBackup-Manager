...
def test_legacy_database_receives_additive_columns():
    ...
    assert {"archive_prefix", "archive_prefix_history_json", "create_options_json", "source_size_bytes", "source_file_count", "source_stats_checked_at", "source_stats_origin", "source_stats_detail_json"} <= job_columns
    assert {"repository_id", "job_name_snapshot", "log_output", "warning_summary_json", "borg_version", "trigger_type", "schedule_name_snapshot", "archive_name_snapshot", "backup_original_size_bytes", "backup_compressed_size_bytes", "backup_deduplicated_size_bytes", "backup_file_count", "backup_source_size_bytes_snapshot", "backup_source_file_count_snapshot", "backup_network_download_bytes", "backup_network_upload_bytes"} <= run_columns
